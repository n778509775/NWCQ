...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_epochs', type=int, default=55, help='number of total iterations for training')
    parser.add_argument('--lr_step', type=int, default=10000, help='step decay of learning rates')
    parser.add_argument('--base_lr', type=float, default=5e-6, help='learning rate for network')
    ...
    for epoch in range(1, num_epochs + 1):
        ...
        for it in range(0, num_iter):
            ...
            for rep in range(1):
                ...
                loss = 0.1 * loss_reconstruct + 10 * loss_transfer
